package ch.invictech.vehicleManagement.ui.registerVehicle;
...
public class RegisterVehicle implements Initializable {
    ...
    public void confirm() {
        if(isAllSet()) {
            ...
            try {
                ...
                Parent view = FXMLLoader.load(getClass().getResource("../../../../../../resources/ch/invictech/vehicleManagement/ui/displayVehicles/displayVehicles.fxml"));
    ...
    private boolean isAllSet() {
        ...
        if(vehicleType.getValue() != null) {
            ...
            return ViewHelper.isAllSet(list);
        } else {
            return false;
        }
    }
